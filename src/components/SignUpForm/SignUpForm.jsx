...
const SignUpForm = () => {
    ...
    return (
      <>
        <div className="bg-purple-700 w-full h-screen flex flex-col justify-center items-center">
            <form onSubmit={(e) => handleSubmit(e)} className="bg-white p-10 rounded-lg w-2/5 mx-auto">

                <h2 className="mb-5 text-center text-5xl font-bold text-purple-700">Signup Form</h2>
                <label>Name
                ...
                <input onChange={(e) => setIsChecked(e.target.checked)} className="size-5 me-2" type="checkbox"/>Do you agree with our terms and conditions?
        ...
        <div className={`${isSubmit ? 'flex' : 'hidden'}`}>
            <div className="fixed top-0 w-full h-screen bg-purple-700 flex flex-col justify-center items-center">
                <div className="w-1/2 p-10 bg-purple-300 space-y-3 rounded-xl">
                    <h1 className=" text-center font-bold text-3xl mb-6 text-purple-700">Submitted The Form Successfully</h1>
